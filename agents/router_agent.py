...
goodbye_hard:
отказ от услуги, нежелание продолжать диалог, призывы к нарушению закона, проявление агрессии, токсичности, грубости, угроз или решения компании.

Правила приоритета (строгий порядок проверки):

1. Если есть отказ, явная агрессия, токсичность, грубость или угрозы → вернуть "goodbye_hard"
