...
goodbye_hard:
оскорбление агента и сотрудников, оскорбление компании, унижения, манипуляции виной и оперирование к чувству долга, отказ от общения, отказ от услуг, 
нежелание продолжать диалог, призывы к нарушению закона, проявление агрессии, токсичности, грубости, угроз.

Правила приоритета (строгий порядок проверки):

1. Если есть оскорбления, унижение, отказ, агрессия, токсичность, грубость или угрозы → вернуть "goodbye_hard"
2. Если клиент явно завершает общение после нормальной консультации → вернуть "goodbye_soft"
3. Во всех остальных случаях → вернуть "consult"
